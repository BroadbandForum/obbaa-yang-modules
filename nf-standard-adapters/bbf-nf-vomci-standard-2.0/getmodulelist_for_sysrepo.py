    ...
    for line in tmpfile:
        ...
        if (line.strip().startswith("revision") == True and revision==""):
            ...
            try:
                ...
                print("Error getting namespace on: " + filename + " " + line );
                print(e)
                namespace="#####################"
                sys.exit()
            ...
            if feature.find(" ") == -1: 
                ...
                if (mainmoduleName not in mainModuleList):
                    ...
                    mainModuleList[mainmoduleName]['revision'] = ""
...
for filename in sorted(os.listdir(yang_directory + "/" + subdirname)):
    if filename.endswith(".yang"): 
        ...
        if isMain == True:
            print(filename);
            mainModuleName = filename.split(".yang")[0].split('@')[0]
